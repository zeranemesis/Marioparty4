...
enum {
	...
	TITLE_PRESS_START_ANM = DATA_MAKE_NUM(DATADIR_TITLE, 1),
...
#define TITLE_ANM_VER_ADJUSTED(anm) (partyboard_version_is_pal() ? anm : (((anm & 0xF) < 6 ? anm + 1 : anm + 2)))
...
#define TITLE_ANM_VER_ADJUSTED(anm) anm
