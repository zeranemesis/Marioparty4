...
inline std::string ui_translate(std::string_view text)
{
    ...
    static constexpr Entry entries[] = {
        ...
        {"Update Available", "Mise à jour disponible"}, {"Update", "Mettre à jour"}, {"Install", "Installer"}, {"Later", "Plus tard"}, {"Retry", "Réessayer"},
        {"Check for Updates", "Rechercher les mises à jour"}, {"Check Now", "Rechercher maintenant"},
        {"Look for a newer build on GitHub when Party Board starts. When there is one, the home screen offers to install it; nothing is downloaded without asking.", "Cherche une version plus récente sur GitHub au démarrage de Party Board. S’il y en a une, l’écran d’accueil propose de l’installer ; rien n’est téléchargé sans votre accord."},
        ...
        {"Downloading the update... {}%", "Téléchargement de la mise à jour… {} %"}, {"Downloading the update...", "Téléchargement de la mise à jour…"},
        {"Confirm the installation in Android's window.", "Confirmez l’installation dans la fenêtre d’Android."},
        {"Party Board build {} is available. This phone has build {}.", "La build {} de Party Board est disponible. Ce téléphone a la build {}."},
        {"What changed:", "Ce qui change :"}, {"Your saves and settings are kept.", "Vos sauvegardes et vos réglages sont conservés."},
        ...
        {"The update could not be started.", "La mise à jour n’a pas pu démarrer."},
        {"The update could not be downloaded.", "La mise à jour n’a pas pu être téléchargée."},
        {"The download does not match the SHA-256 GitHub announced. Nothing was installed.", "Le fichier téléchargé ne correspond pas au SHA-256 annoncé par GitHub. Rien n’a été installé."},
        {"The update was cancelled.", "La mise à jour a été annulée."},
        {"The update could not be installed.", "La mise à jour n’a pas pu être installée."},
        {"This build is signed with a different key than the installed one. Back up your saves, uninstall Party Board once, then install the update from GitHub.", "Cette build est signée avec une autre clé que celle installée. Sauvegardez vos données, désinstallez Party Board une fois, puis installez la mise à jour depuis GitHub."},
    };
